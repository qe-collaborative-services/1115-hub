...
sources:
  - uri: >-
      support/assurance/ahc-hrsn-elt/screening/synthetic-content/SCREENING_healthelink-20240304-testcase1.csv
    nature: CSV
    tableName: screening_healthelink_20240304_testcase1
    ingestionIssues: 0
  - uri: >-
      support/assurance/ahc-hrsn-elt/screening/synthetic-content/QE_ADMIN_DATA_healthelink-20240304-testcase1.csv
    nature: CSV
    tableName: qe_admin_data_healthelink_20240304_testcase1
    ingestionIssues: 0
  - uri: >-
    ...
    ingestionIssues: 1
  - uri: >-
      support/assurance/ahc-hrsn-elt/screening/synthetic-content/DEMOGRAPHIC_DATA_healthelink-20240304-testcase1.csv
    nature: CSV
    tableName: admin_demographics_healthelink_20240304_testcase1
    ingestionIssues: 0
  - uri: >-
...
SET autoload_known_extensions=true;
-- end preambleSQL
-- ingest support/assurance/ahc-hrsn-elt/screening/synthetic-content/SCREENING_healthelink-20240304-testcase1.csv (screening_healthelink_20240304_testcase1)
-- required by IngestEngine, setup the ingestion entry for logging
INSERT INTO "orch_session_entry" ("orch_session_entry_id", "session_id", "ingest_src", "ingest_table_name", "elaboration") VALUES ('8b7c669c-1795-5f6b-8f3a-3e502b74c628', '05269d28-15ae-5bd6-bd88-f949ccfa52d7', 'support/assurance/ahc-hrsn-elt/screening/synthetic-content/SCREENING_healthelink-20240304-testcase1.csv', 'screening_healthelink_20240304_testcase1', NULL);
...
CREATE TABLE screening_healthelink_20240304_testcase1 AS
  SELECT *, row_number() OVER () as src_file_row_number, '05269d28-15ae-5bd6-bd88-f949ccfa52d7' as session_id, '8b7c669c-1795-5f6b-8f3a-3e502b74c628' as session_entry_id
    FROM read_csv_auto('support/assurance/ahc-hrsn-elt/screening/synthetic-content/SCREENING_healthelink-20240304-testcase1.csv');
    ...
    SELECT column_name
     ...
     WHERE required.column_name NOT IN (
         SELECT column_name
          ...
          WHERE table_name = 'screening_healthelink_20240304_testcase1')
)
INSERT INTO orch_session_issue (orch_session_issue_id, session_id, session_entry_id, issue_type, issue_message, remediation)
    SELECT uuid(),
           ...
           'Missing Column',
           'Required column ' || column_name || ' is missing in screening_healthelink_20240304_testcase1.',
           'Ensure screening_healthelink_20240304_testcase1 contains the column "' || column_name || '"'
...
-- ingest support/assurance/ahc-hrsn-elt/screening/synthetic-content/QE_ADMIN_DATA_healthelink-20240304-testcase1.csv (qe_admin_data_healthelink_20240304_testcase1)
-- required by IngestEngine, setup the ingestion entry for logging
INSERT INTO "orch_session_entry" ("orch_session_entry_id", "session_id", "ingest_src", "ingest_table_name", "elaboration") VALUES ('641dff51-97fd-56b3-8443-c1ed568a6d66', '05269d28-15ae-5bd6-bd88-f949ccfa52d7', 'support/assurance/ahc-hrsn-elt/screening/synthetic-content/QE_ADMIN_DATA_healthelink-20240304-testcase1.csv', 'qe_admin_data_healthelink_20240304_testcase1', NULL);
...
-- be sure to add src_file_row_number and session_id columns to each row
-- because assurance CTEs require them
CREATE TABLE qe_admin_data_healthelink_20240304_testcase1 AS
  SELECT *, row_number() OVER () as src_file_row_number, '05269d28-15ae-5bd6-bd88-f949ccfa52d7' as session_id, '641dff51-97fd-56b3-8443-c1ed568a6d66' as session_entry_id
    FROM read_csv_auto('support/assurance/ahc-hrsn-elt/screening/synthetic-content/QE_ADMIN_DATA_healthelink-20240304-testcase1.csv');
...
WITH required_column_names_in_src AS (
    SELECT column_name
     ...
     WHERE required.column_name NOT IN (
         SELECT column_name
           FROM information_schema.columns
          WHERE table_name = 'qe_admin_data_healthelink_20240304_testcase1')
)
INSERT INTO orch_session_issue (orch_session_issue_id, session_id, session_entry_id, issue_type, issue_message, remediation)
    SELECT uuid(),
           '05269d28-15ae-5bd6-bd88-f949ccfa52d7',
           ...
           'Missing Column',
           'Required column ' || column_name || ' is missing in qe_admin_data_healthelink_20240304_testcase1.',
           'Ensure qe_admin_data_healthelink_20240304_testcase1 contains the column "' || column_name || '"'
      FROM required_column_names_in_src;
...
-- ingest support/assurance/ahc-hrsn-elt/screening/synthetic-content/DEMOGRAPHIC_DATA_healthelink-20240304-testcase1.csv (admin_demographics_healthelink_20240304_testcase1)
-- required by IngestEngine, setup the ingestion entry for logging
INSERT INTO "orch_session_entry" ("orch_session_entry_id", "session_id", "ingest_src", "ingest_table_name", "elaboration") VALUES ('86b4a49e-7378-5159-9f41-b005208c31bc', '05269d28-15ae-5bd6-bd88-f949ccfa52d7', 'support/assurance/ahc-hrsn-elt/screening/synthetic-content/DEMOGRAPHIC_DATA_healthelink-20240304-testcase1.csv', 'admin_demographics_healthelink_20240304_testcase1', NULL);
...
-- be sure to add src_file_row_number and session_id columns to each row
-- because assurance CTEs require them
CREATE TABLE admin_demographics_healthelink_20240304_testcase1 AS
  SELECT *, row_number() OVER () as src_file_row_number, '05269d28-15ae-5bd6-bd88-f949ccfa52d7' as session_id, '86b4a49e-7378-5159-9f41-b005208c31bc' as session_entry_id
    FROM read_csv_auto('support/assurance/ahc-hrsn-elt/screening/synthetic-content/DEMOGRAPHIC_DATA_healthelink-20240304-testcase1.csv', types={'SEX_AT_BIRTH_CODE': 'VARCHAR', 'ADMINISTRATIVE_SEX_CODE': 'VARCHAR'});
...
WITH required_column_names_in_src AS (
    SELECT column_name
     ...
     WHERE required.column_name NOT IN (
         SELECT column_name
           FROM information_schema.columns
          WHERE table_name = 'admin_demographics_healthelink_20240304_testcase1')
)
INSERT INTO orch_session_issue (orch_session_issue_id, session_id, session_entry_id, issue_type, issue_message, remediation)
    SELECT uuid(),
           '05269d28-15ae-5bd6-bd88-f949ccfa52d7',
           ...
           'Missing Column',
           'Required column ' || column_name || ' is missing in admin_demographics_healthelink_20240304_testcase1.',
           'Ensure admin_demographics_healthelink_20240304_testcase1 contains the column "' || column_name || '"'
      FROM required_column_names_in_src;
...
WITH mandatory_value AS (
    SELECT 'PAT_MRN_ID' AS issue_column,
      ...
      FROM "screening_healthelink_20240304_testcase1"
...
WITH valid_pat_mrn_id_across_all_three_tables AS (
  SELECT 'PAT_MRN_ID' AS issue_column, 'screening_healthelink_20240304_testcase1' AS issue_table_name, a.PAT_MRN_ID AS invalid_pat_value, a.FACILITY_ID AS invalid_facility_value, a.src_file_row_number AS issue_row
  FROM screening_healthelink_20240304_testcase1 a
  LEFT JOIN qe_admin_data_healthelink_20240304_testcase1 b
  ON a.PAT_MRN_ID = b.PAT_MRN_ID
  AND a.FACILITY_ID = b.FACILITY_ID
  LEFT JOIN admin_demographics_healthelink_20240304_testcase1 c
  ...
  UNION
  SELECT 'PAT_MRN_ID' AS issue_column, 'qe_admin_data_healthelink_20240304_testcase1' AS issue_table_name, b.PAT_MRN_ID AS invalid_pat_value, b.FACILITY_ID AS invalid_facility_value, b.src_file_row_number AS issue_row
  FROM qe_admin_data_healthelink_20240304_testcase1 b
  LEFT JOIN screening_healthelink_20240304_testcase1 a
  ON a.PAT_MRN_ID = b.PAT_MRN_ID
  AND a.FACILITY_ID = b.FACILITY_ID
  LEFT JOIN admin_demographics_healthelink_20240304_testcase1 c
  ...
  UNION
  SELECT 'PAT_MRN_ID' AS issue_column, 'admin_demographics_healthelink_20240304_testcase1' AS issue_table_name, c.PAT_MRN_ID AS invalid_pat_value, c.FACILITY_ID AS invalid_facility_value, c.src_file_row_number AS issue_row
  FROM admin_demographics_healthelink_20240304_testcase1 c
  LEFT JOIN screening_healthelink_20240304_testcase1 a
  ON a.PAT_MRN_ID = c.PAT_MRN_ID
  AND a.FACILITY_ID = c.FACILITY_ID
  LEFT JOIN qe_admin_data_healthelink_20240304_testcase1 b
...
WITH valid_encounter_class_in_all_rows AS (
    SELECT 'ENCOUNTER_CLASS_CODE' AS issue_column,
      ...
      FROM screening_healthelink_20240304_testcase1 sr
...
WITH valid_answer_code_in_all_rows AS (
  SELECT 'ANSWER_CODE' AS issue_column,
    ...
    FROM screening_healthelink_20240304_testcase1 scr
...
WITH mandatory_value AS (
    SELECT 'PAT_MRN_ID' AS issue_column,
           "PAT_MRN_ID" AS invalid_value,
           src_file_row_number AS issue_row
      FROM "qe_admin_data_healthelink_20240304_testcase1"
     WHERE "PAT_MRN_ID" IS NULL
        OR TRIM("PAT_MRN_ID") = ''
)
INSERT INTO orch_session_issue (orch_session_issue_id, session_id, session_entry_id, issue_type, issue_row, issue_column, invalid_value, issue_message, remediation)
...
WITH mandatory_value AS (
    SELECT 'FIRST_NAME' AS issue_column,
           ...
           src_file_row_number AS issue_row
      FROM "admin_demographics_healthelink_20240304_testcase1"
...
WITH valid_administrative_sex_code_in_all_rows AS (
    SELECT 'ADMINISTRATIVE_SEX_CODE' AS issue_column,
           ...
           sr.src_file_row_number AS issue_row
      FROM admin_demographics_healthelink_20240304_testcase1 sr
...
INSERT INTO "orch_session_state" ("orch_session_state_id", "session_id", "session_entry_id", "from_state", "to_state", "transition_result", "transition_reason", "transitioned_at", "elaboration") VALUES ('8f460419-7b80-516d-8919-84520950f612', '05269d28-15ae-5bd6-bd88-f949ccfa52d7', NULL, 'EXIT(prepareInit)', 'ENTER(init)', NULL, 'rsEE.afterCell', ('2024-03-07T11:12:57.730Z'), NULL);
INSERT INTO "orch_session_state" ("orch_session_state_id", "session_id", "session_entry_id", "from_state", "to_state", "transition_result", "transition_reason", "transitioned_at", "elaboration") VALUES ('1931dfcc-e8fc-597d-b1bc-65b4287e6fdf', '05269d28-15ae-5bd6-bd88-f949ccfa52d7', NULL, 'EXIT(init)', 'ENTER(ingest)', NULL, 'rsEE.afterCell', ('2024-03-07T11:12:57.730Z'), NULL);
INSERT INTO "orch_session_state" ("orch_session_state_id", "session_id", "session_entry_id", "from_state", "to_state", "transition_result", "transition_reason", "transitioned_at", "elaboration") VALUES ('21d7e4ec-32e3-5e20-9029-28fdd6c5fa66', '05269d28-15ae-5bd6-bd88-f949ccfa52d7', NULL, 'EXIT(ingest)', 'ENTER(ensureContent)', NULL, 'rsEE.afterCell', ('2024-03-07T11:12:57.730Z'), NULL);
INSERT INTO "orch_session_state" ("orch_session_state_id", "session_id", "session_entry_id", "from_state", "to_state", "transition_result", "transition_reason", "transitioned_at", "elaboration") VALUES ('f626602e-8be5-5e8c-824c-bdde91b22817', '05269d28-15ae-5bd6-bd88-f949ccfa52d7', NULL, 'EXIT(ensureContent)', 'ENTER(emitResources)', NULL, 'rsEE.afterCell', ('2024-03-07T11:12:57.730Z'), NULL);
...
CREATE TABLE IF NOT EXISTS screening AS SELECT * FROM screening_healthelink_20240304_testcase1 WHERE 0=1;
INSERT INTO screening SELECT * FROM screening_healthelink_20240304_testcase1;

CREATE TABLE resource_db.screening_healthelink_20240304_testcase1 AS SELECT * FROM screening_healthelink_20240304_testcase1;

CREATE TABLE IF NOT EXISTS resource_db.screening AS SELECT * FROM screening_healthelink_20240304_testcase1 WHERE 0=1;
INSERT INTO resource_db.screening SELECT * FROM screening_healthelink_20240304_testcase1;
...
CREATE VIEW screening_fhir AS
  ...
  FROM screening_healthelink_20240304_testcase1 as tab_screening LEFT JOIN admin_demographics_healthelink_20240304_testcase1 as tab_demograph
...
CREATE TABLE IF NOT EXISTS qe_admin_data AS SELECT * FROM qe_admin_data_healthelink_20240304_testcase1 WHERE 0=1;
INSERT INTO qe_admin_data SELECT * FROM qe_admin_data_healthelink_20240304_testcase1;

CREATE TABLE resource_db.qe_admin_data_healthelink_20240304_testcase1 AS SELECT * FROM qe_admin_data_healthelink_20240304_testcase1;

CREATE TABLE IF NOT EXISTS resource_db.qe_admin_data AS SELECT * FROM qe_admin_data_healthelink_20240304_testcase1 WHERE 0=1;
INSERT INTO resource_db.qe_admin_data SELECT * FROM qe_admin_data_healthelink_20240304_testcase1;
...
CREATE TABLE IF NOT EXISTS demographic_data AS SELECT * FROM admin_demographics_healthelink_20240304_testcase1 WHERE 0=1;
INSERT INTO demographic_data SELECT * FROM admin_demographics_healthelink_20240304_testcase1;

CREATE TABLE resource_db.admin_demographics_healthelink_20240304_testcase1 AS SELECT * FROM admin_demographics_healthelink_20240304_testcase1;

CREATE TABLE IF NOT EXISTS resource_db.demographic_data AS SELECT * FROM admin_demographics_healthelink_20240304_testcase1 WHERE 0=1;
INSERT INTO resource_db.demographic_data SELECT * FROM admin_demographics_healthelink_20240304_testcase1;
